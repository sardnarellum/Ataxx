...
public final class AtaxxCommon {
	...
	/**
	 * Determines that an empty field exists in the two fields distance around a
	 * field of a {@link Board}.
	 * 
	 * @param board
	 * @param row
	 * @param col
	...
	/**
	 * Counts the number of the same pieces with a given {@link Piece} on a
	 * {@link Board}.
	 * 
	 * @param board
	 *            The board to search on.
	 * @param piece
	 *            The piece to be searched.
	 ...
	 * 
	 * @param row
	 *            number of the new piece's row in the upper left quadrant.
	 * @param col
	 *            number of the new piece's column in the upper left quadrant.
	 * @param b
	 *            the {@link Board} to be modified.
	 * @param p
	 *            the {@link Piece} to be inserted.
	 */
	...
	/**
	 * Returns the winner piece if only one type of piece exists on the board.
	 * 
	 * @param board
	 * 
	 * @param pieces
	 ...
	 * @return
	 */
	public static Piece uniqueWinner(Board board, List<Piece> pieces) {
		Piece p = null;
